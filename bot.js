...
ويمكنك دعوة البوت الي سيرفرك لكن بشرط ألا تقول أنك مالك البوت
لأن مالك البوت الأصلي هو
! Ezio's I Kemo_DX#0232
**
`)
...
message.member.removeRole(message.guild.roles.find("name", "39"));
message.member.removeRole(message.guild.roles.find("name", "40"));
message.member.removeRole(message.guild.roles.find(
